    ...
    <p className="text-white">.</p>
       <div className='mt-16 w-[96%] flex justify-between'>
        ...
        <div className="float-left text-left mt-4 text-sm ">
            <ul className="list-disc list-inside marker:text-[#A445ED] text-sm md:-ml-14 lg:-ml-14 xl:-ml-20 md:mt-6 lg:mt-10 xl:mt-10 xl:text-xl lg:text-lg">
        ...
        <br/>
        <hr className="w-[100%] mt-60 md:mt-36 lg:mt-72 xl:mt-72"/>
        <div className="mt-7 float-left md:flex md:gap-6 lg:flex lg:gap-6 lg:text-xl xl:text-2xl">
            <h1 className="text-[#838383] text-sm float-left lg:text-lg xl:text-xl">Source</h1>
            <h1 className="text-sm lg:text-lg xl:text-xl">https://en.wiktionary.org/wiki/keyboard</h1>
            <br/><br/><br/>
        </div>
    </>
  )
